...
class _TasksScreenState extends State<TasksScreen> {
  ...
  Future<void> _loadTasks() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('تعذر تحميل المهام')),
      );
    }
  }
  ...
  Future<void> _openForm({DailyTask? task}) async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('تعذر حفظ المهمة')),
        );
      }
      return;
    }
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(task == null ? 'تمت إضافة المهمة' : 'تم تعديل المهمة'),
  ...
  Future<void> _toggleTask(DailyTask task) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            newValue ? 'تم إنجاز المهمة' : 'تمت إعادة المهمة',
          ),
        ),
      );
    } catch (_) {
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('المواعيد والمهام'),
          centerTitle: true,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              'أنجزت $_completed من ${_tasks.length} مهام',
      ...
      child: ListTile(
        ...
        trailing: PopupMenuButton<String>(
          ...
          itemBuilder: (_) => [
            PopupMenuItem(
              value: 'done',
              child: Text(task.isDone ? 'إلغاء الإنجاز' : 'تحديد كمكتملة'),
            ),
  ...
  void _save() {
    ...
    Navigator.pop(
      ...
      DailyTask(
        ...
        priority: _priority,
        icon: widget.task?.icon ?? Icons.task_alt,
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (value) =>
                      setState(() => _priority = value ?? 'متوسطة'),
                ),
              ],
            ),
          ),
